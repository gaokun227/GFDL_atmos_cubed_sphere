...
real, public, parameter :: RADIUS = 6371e+3_r8_kind * small_fac
real(kind=8), public, parameter :: PI_8 = 3.141592653589793_r8_kind
...
real, public, parameter :: RHO0R   = 1.0_r8_kind/RHO0
...
real, public, parameter :: WTMAIR = 2.896440E+01_r8_kind
real, public, parameter :: WTMH2O = WTMAIR*(RDGAS/RVGAS) !pjp OK to change value because not used yet.
!real, public, parameter :: WTMO3  = 47.99820E+01_r8_kind
real, public, parameter :: WTMOZONE =  47.99820_r8_kind
real, public, parameter :: WTMC     =  12.00000_r8_kind
real, public, parameter :: WTMCO2   =  44.00995_r8_kind
real, public, parameter :: WTMO2    =  31.9988_r8_kind
real, public, parameter :: WTMCFC11 = 137.3681_r8_kind
real, public, parameter :: WTMCFC12 = 120.9135_r8_kind
real, public, parameter :: DIFFAC = 1.660000E+00_r8_kind
real, public, parameter :: SECONDS_PER_DAY  = 8.640000E+04_r8_kind, SECONDS_PER_HOUR = 3600._r8_kind, SECONDS_PER_MINUTE=60._r8_kind
real, public, parameter :: AVOGNO = 6.023000E+23_r8_kind
real, public, parameter :: PSTD   = 1.013250E+06_r8_kind
real, public, parameter :: PSTD_MKS    = 101325.0_r8_kind
...
real, public, parameter :: O2MIXRAT    = 2.0953E-01_r8_kind
real, public, parameter :: RHOAIR      = 1.292269_r8_kind
real, public, parameter :: ALOGMIN     = -50.0_r8_kind
...
real, public, parameter :: C2DBARS = 1.e-4_r8_kind
