...
!--------------------------------------------
       ...
       nudge_diag%nudge_t_dt = pt(is:ie,js:je,:)
       nudge_diag%nudge_ps_dt = ps(is:ie,js:je)
       nudge_diag%nudge_delp_dt = delp(is:ie,js:je,:)
       nudge_diag%nudge_u_dt = ua(is:ie,js:je,:)
       nudge_diag%nudge_v_dt = va(is:ie,js:je,:)
...
!$omp parallel do default(none) shared(is,ie,js,je,npz,bk,delp,ps_dt) private(dbk)
       ...
       nudge_diag%nudge_ps_dt = (ps(is:ie,js:je) - nudge_diag%nudge_ps_dt) / dt
       nudge_diag%nudge_delp_dt = (delp(is:ie,js:je,:) - nudge_diag%nudge_delp_dt) / dt
       nudge_diag%nudge_u_dt = (ua(is:ie,js:je,:) - nudge_diag%nudge_u_dt) / dt
       nudge_diag%nudge_v_dt = (va(is:ie,js:je,:) - nudge_diag%nudge_v_dt) / dt
...
! All fields will be updated except winds; wind tendencies added
       ...
       nudge_diag%nudge_ps_dt = ps(is:ie,js:je)
       nudge_diag%nudge_delp_dt = delp(is:ie,js:je,:)
       nudge_diag%nudge_u_dt = u_dt(is:ie,js:je,:)
       nudge_diag%nudge_v_dt = v_dt(is:ie,js:je,:)
