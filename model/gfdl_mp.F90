...
subroutine neg_adj (ks, ke, tz, dp, qv, ql, qr, qi, qs, qg, condensation, convt)
...
subroutine mp_full (ks, ke, ntimes, tz, qv, ql, qr, qi, qs, qg, dp, dz, u, v, w, &
        ...
        condensation, evaporation, deposition, sublimation, convt, last_step)
